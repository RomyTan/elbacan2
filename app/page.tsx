...
const [stage, setStage] = useState<'verification' | 'transition' | 'home'>('verification');
...
// Background klasik pesanan klien
const bgImagePath = "/images/hero-bg-classic.jpg";
...
const collectionData: CigarData[] = [
...
{ name: 'ELEGANTES', ring: '50', length: '7"', time: '40-45min', intensity: 2, wrapper: 'Connecticut', image: '/images/ebpe-elegantes_connecticut.jpg', badge: null },
...
{ name: 'CLASICOS', ring: '52', length: '6"', time: '30-40min', intensity: 4, wrapper: 'Maduro', image: '/images/ebpe-clasicos_maduro.jpg', badge: null },
...
{ name: 'SELECTOS', ring: '50', length: '5"', time: '20-25min', intensity: 4, wrapper: 'Maduro', image: '/images/ebpe-selectos_maduro.jpg', badge: null },
...
{ name: 'UNICOS', ring: '60', length: '6"', time: '45-55min', intensity: 4, wrapper: 'Maduro', image: '/images/ebpe-unicos_maduro.jpg', badge: null },
];
...
const handleSlideScroll = (e: React.UIEvent) => {
const target = e.currentTarget;
const itemWidth = target.clientWidth * 0.85;
const index = Math.round(target.scrollLeft / itemWidth);
setActiveSlide(index);
};

const handleWrapperScroll = (e: React.UIEvent) => {
const target = e.currentTarget;
const itemWidth = target.clientWidth * 0.85;
const index = Math.round(target.scrollLeft / itemWidth);
...
const handleWrapperArrowClick = (direction: 'left' | 'right') => {
...
El Bacán - Premium Cigars
  ...
  <style dangerouslySetInnerHTML={{ __html: `
    ...
    .tab-btn { font-family: 'Arpona-Semibold', serif; font-size: 18px; padding: 10px 28px; cursor: pointer; background-color: #ffffff; color: #1c1c1c; border: 1px solid #d1c8bb; transition: all 0.3s ease; border-radius: 6px; }
