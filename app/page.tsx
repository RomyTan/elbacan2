...
export default function ElBacanApp() {
  ...
  // --- SESUAI FEEDBACK CLIENT: Ganti nama file di sini nanti dengan gambar Havana/Tobacco ---
  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* FIX OVERFLOW & SAFE AREA */
        html, body { 
          margin: 0; padding: 0; overflow-x: hidden; 
          font-family: 'Arpona', serif; background-color: #000000; 
          width: 100%; max-width: 100vw; min-height: 100dvh; 
        }
        ...
        /* Note: mix-blend-mode dihilangkan agar kompatibel dengan gambar abu-abu milikmu saat ini */
